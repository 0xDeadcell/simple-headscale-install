...
https://github.com/0xDeadcell/simple-headscale-install/releases/download/v1.1.0/release_setup_headscale-x64_v1.1.0.exe

If you prefer to run it via the command line:

	curl https://github.com/0xDeadcell/simple-headscale-install/releases/download/v1.1.0/release_setup_headscale-x64_v1.1.0.exe -o setup_headscale.exe && setup_headscale.exe https://hs.yourdomain.com preauthkey
